...
public class AbiturientArray {
    ...
    public AbiturientArray() throws AbiturientException {
    ...
    public AbiturientArray(String fileName) throws FileNotFoundException, AbiturientException {
    ...
    private Abiturient defineAbiturient() throws AbiturientException {
